...
class Mauritius extends StatefulWidget {
  @override
  State<Mauritius> createState() => _MauritiusState();
}

class _MauritiusState extends State<Mauritius> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Mauritius"),
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Image.asset("assets/foto/mauritius.jpg"),
           Text(
              ...
              Text(""),
              Text(
                'Burung Mauritius/afrika selatan',
                style: TextStyle(
                  color: Colors.blue,
                  fontSize: 20,
                ),
